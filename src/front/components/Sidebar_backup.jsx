...
export const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
    ...
    return (
        <>
            ...
            <div className={`fixed left-0 top-0 h-full glass-effect shadow-2xl border-r border-gray-200/30 transition-all duration-500 ease-out z-50 ${isCollapsed ? 'w-16' : 'w-72'
                } backdrop-blur-xl`}>
