...
class Department(db.Model):
    ...
    admins = db.relationship(
        'AdminDepartment', back_populates='department', lazy='dynamic')
    tickets = db.relationship(
        'Ticket', back_populates='department', lazy='dynamic')
...
class TicketEnhanced(db.Model):
    ...
    creator = db.relationship('User', foreign_keys=[
                              created_by], back_populates='created_tickets')
    assignee = db.relationship('User', foreign_keys=[
                               assigned_to], back_populates='assigned_tickets')
    department = db.relationship('Department', back_populates='tickets')
    comments = db.relationship(
        'TicketComment', back_populates='ticket', lazy='dynamic')
    history = db.relationship(
        'TicketHistory', back_populates='ticket', lazy='dynamic')
